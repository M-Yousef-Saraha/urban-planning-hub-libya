...
// Note: Admin functions for request approval/rejection have been consolidated into adminController

export const getRequestDetails = async (req: Request, res: Response): Promise<Response | void> => {
  try {
    const { id } = req.params;
    ...
    const request = await prisma.documentRequest.findUnique({
      ...
      include: {
        ...
        downloadTokens: {
          where: { downloadedAt: null }, // Only active tokens
