...
const LibrarySimple = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50" dir="rtl">
      ...
      {/* Hero Section */}
      <div className="bg-white header-safe-padding py-12 border-b border-gray-200">
        <PageContainer className="text-center" withHeaderSpacing={false}>
          <h1 className="text-4xl md:text-5xl font-bold mb-3 text-gray-900">مكتبة الوثائق</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-400 focus:border-gray-400 text-right bg-white shadow-sm transition-all hover:shadow-md"
              />
            </div>
